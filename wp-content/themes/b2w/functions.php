...
if ( ! function_exists( 'b2w_setup' ) ) :
	...
	function b2w_setup() {
		 ...
		 * If you're building a theme based on B2W, use a find and replace
		 * to change 'b2w' to the name of your theme in all the template files.
		 */
		...
		add_theme_support( 'custom-background', apply_filters( 'b2w_custom_background_args', array(
...
function b2w_scripts() {
	...
	wp_enqueue_script( 'b2w-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'b2w-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
